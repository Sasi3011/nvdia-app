...
import { ExternalHackathons, type ExternalHackathonsHandle } from "../../../components/modules/ExternalHackathons";
  ...
  return (
    <ConsoleShell role="ADMIN">
      <ConsolePageHeader
        ...
        description="Create and manage AI hackathons and team registries."
        actions={
          <div className="flex items-center gap-2.5">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 rounded-xl bg-[#1755A7] px-4 py-2.5 text-xs font-bold text-white hover:bg-[#134486] transition-all active:scale-95"
            >
      ...
      <div className="mt-4 mb-8"><ExternalHackathons canManage hideHeaderActions ref={externalRef} /></div>
