  ...
  return (
    <ProgramModulePage
      ...
      steps={[
        ...
        { title: "Upload certificate", description: "Upload PDF proof into PostgreSQL-backed storage for faculty review." },
        { title: "Receive approval", description: "Faculty verifies and points are awarded to your AI Passport." },
      ]}
      sections={[
        ...
        { title: "Verification data", items: ["Certificate PDF", "Issuer/platform", "Course title", "Completion date", "Credential URL", "Faculty/admin feedback"] },
      ]}
    />
  );
}
