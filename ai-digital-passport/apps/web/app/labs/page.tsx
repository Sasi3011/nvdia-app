  ...
  return (
    <ProgramModulePage
      ...
      sections={[
        ...
        { title: "Student UI needs", items: ["Lab instructions", "Starter files/dataset link", "GPU requirement", "Submission status", "Mentor score and feedback", "Resubmission option"] },
      ]}
    />
  );
}
