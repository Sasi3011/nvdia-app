...
import { LiveQrDisplay } from "../admin/LiveQrDisplay";
...
// CoE Classes & live QR sessions management. Shared by the admin CoE Classes
// page and the faculty CoE Classes page (Manage tab).
